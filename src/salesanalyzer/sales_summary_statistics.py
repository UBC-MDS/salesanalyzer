...
def sales_summary_statistics(sales_data, quantity_col='Quantity', price_col='UnitPrice', 
                              customer_col='CustomerID', invoice_col='InvoiceNo', 
    ...
    required_columns = [quantity_col, price_col, customer_col, invoice_col, description_col]
    ...
    top_selling_product_quantity = sales_data.groupby(description_col)[quantity_col].sum().idxmax()
    top_selling_product_revenue = sales_data.groupby(description_col)['Revenue'].sum().idxmax()
    
    average_order_value = sales_data.groupby(invoice_col)['Revenue'].sum().mean()
